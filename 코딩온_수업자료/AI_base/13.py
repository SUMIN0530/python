...
# 부트스트랩 샘플
# 샘플1 : [1, 1, 3, 4, 5, 6, 6, 7, 9]  -> 모델 1
# 샘플2 : [1, 2. 2. 4. 6. 6. 6. 7. 9]  -> 모델 2
# 샘플3 : [1, 3, ,3 4, 5, 6, 8, 8, 9]  -> 모델 3
# 
# 예측 종합 (투표/평균)
# 
# 최종 예측
...
model = RandomForestClassifier(
    n_estimators=100,     # 트리 개수 (많을수록 정확 but, 느려짐)
    max_depth=5,          # 최대 깊이
