...
# 비디오 파일 열기
cap = cv2.VideoCapture('./7. opencv/14923235_1920_1080_30fps.mp4')
...
if not cap.isOpened():
    ...
    # 1초에 몇 프레임을 보여주는지 --> 120fps : 1초에 120장의 사진을 보여준다
    ...
    print(f'재생 시간 : {frame_count / fps:.2f}')
    print(f'코덱 : {fourcc}')
...
# FourCC 코드(코덱 지정)
fourcc = cv2.VideoWriter_fourcc(*'mpwv') # MP4
