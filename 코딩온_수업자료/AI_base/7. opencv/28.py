...
# rgba = cv2.imread('./(PNG 파일)', cv2.IMREAD_UNCHANGED)
...
# PNG 압축 레벨(0~9, 기본값 3)
# 높을수록 파일은 작지만 시간이 오래걸림
cv2.imwrite('fast_png.png', img, [cv2.IMWRITE_PNG_COMPRESSION, 0])
cv2.imwrite('slow_png.png', img, [cv2.IMWRITE_PNG_COMPRESSION, 5])
